...
// Mock-Katalog – hier kannst du beliebig erweitern
export const mockCatalog: EfroProduct[] = [
  {
    id: "dog-bed-cozy-001",
    title: "Cozy Pup Dream Bed",
    description:
      "Super weiches Hundebett fuer kleine und mittlere Hunde – waschbar und rutschfest.",
    price: 49.9,
  ...
  },
  {
    ...
    description:
      "Perfektes Starter-Set fuer neue Hundebesitzer – Bett, Spielzeug und Leckerlis im Bundle.",
    price: 89.9,
  ...
  },
  {
    ...
    title: "Gift Card 50 €",
    description:
      "Digitale Geschenkkarte im Wert von 50 € – perfekt, wenn du unsicher bist.",
    price: 50,
...
// Kleine Helper-Funktionen – spaeter fuer Logik nutzbar
...
export function getProductsByTag(tag: string): EfroProduct[] {
  return mockCatalog.filter((p) => p.tags.includes(tag));
}
