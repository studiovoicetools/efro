...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!sku) return NextResponse.json({ ok: false, error: "SKU fehlt" }, { status: 400 });
    const productData = {
      sku, title: body.title || "", description: body.body_html || "",
      ...
      category: body.product_type || "", tags: body.tags || "",
