...
function _pickRecommended(sb: any): any[] {
  const isProductArray = (v: any): v is any[] => {
    return Array.isArray(v) && (
      v.length === 0 ||
      (v[0] && typeof v[0] === "object" && ("title" in v[0] || "id" in v[0]))
    );
  };
